  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      ...
      children: [
        ...
        // ── Layer 2: organic blobs (no hard edges, very soft) ───────────
        IgnorePointer(
          child: _PageBackground(isDark: isDark),
        ),
  ...
  Widget _buildUploadPlaceholder(BuildContext context) {
    ...
    return Stack(
      ...
      children: [
        ...
        // ── 4. Animated scanner corner brackets ─────────────────────
        Positioned.fill(
          child: CustomPaint(painter: _ScannerBracketsPainter()),
        ),

        // ── 5. Logo watermark — bottom right, very faint ────────────
        Positioned(
          bottom: 14,
          right: 14,
          child: Opacity(
        ...
        // ── 6. Original upload UI — untouched ──────────────────────
        Padding(
